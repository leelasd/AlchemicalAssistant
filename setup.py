...
setup(
  name = 'AlchemicalAssistant',
  packages = ['AlchemicalAssistant'], # this must be the same as the name above
  version = '0.1',
  ...
  entry_points={
        'console_scripts': [
            'AlchemicalAssistant=AlchemicalAssistant.AlchemicalAssistant:main',
        ],
    },
